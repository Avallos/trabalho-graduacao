              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="../banco/cadastrarEndereco.php" method="POST" class="form-horizontal form-label-left" novalidate>
                      ...
                      <span class="section">Informações</span>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select id="cliente" class="form-control col-md-7 col-xs-12" name="cliente" required="required" >
                                    <option value="0">Selecione o Cliente</option>
                                    <?php
                                        $cliente = ("SELECT nome, id FROM clientes ORDER BY nome ASC;");
