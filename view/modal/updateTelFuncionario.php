<!-- Edit Modal -->
          <div class="modal fade" id="telfunmodal" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="../banco/updateTelFuncionario.php" method="POST" class="form-horizontal form-label-left" novalidate>
